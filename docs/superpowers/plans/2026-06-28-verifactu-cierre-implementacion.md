...
| **RD 254/2025**, de 1-abr          | [BOE-A-2025-6600](https://www.boe.es/buscar/doc.php?id=BOE-A-2025-6600)                         | 1er aplazamiento: IS→1-ene-2026, resto→1-jul-2026. _(superado)_                                                               |
...
### Fase 4 — Transporte real a la AEAT (SOAP + mTLS) — _el núcleo pendiente_
...
- **Códigos de error**: tabla de mapeo desde el PDF «Validaciones y errores» del portal
  (extraer al implementar; distinguir _reintentable_ vs _requiere subsanación_).
...
- Distinguir en UI: _reintentable_ (problema de transporte) vs _requiere subsanación_
...
- **Formalización del acuerdo de colaboración social (tipo 017)** — trámite legal previo al
  modo C. Hasta entonces, modos A/B. _(Confianza alta en que existe; confirmar alcance exacto
  para VERI\*FACTU en el trámite.)_
...
| Apoderamiento notarial (evitado al usar colaborador social)                                       | ~60–120 € _(no incurrido)_                 |
| SaaS de terceros (evitado)                                                                        | 2,9 €/NIF/mes … 110 €/año _(no incurrido)_ |
