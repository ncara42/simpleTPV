...
**Hecho: tandas 0, 1, 2, 3, 5, 6, 7, 8** (24 widgets nuevos + 2 clásicos conservados, 9 categorías de la
galería pobladas). Cada tanda con su test (datos mock + paridad) y la puerta verde (typecheck + lint +
unit + build). La Tanda 8 además verificada por captura propia vs. el handoff. **Tanda 4 DEFERIDA**
(faltan datos). **Pendiente: tandas 9, 10, 11** (ver roadmap; varios widgets diferidos por falta de
