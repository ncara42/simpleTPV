...
// A-01: el modo demo es OPT-IN. Solo VITE_DEMO_MODE === 'true' lo activa; cualquier
// otro valor (o ausente) deja el modo REAL, para que producción nunca caiga en demo.
