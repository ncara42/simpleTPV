...
// Carril de facetas de Clientes B2B: búsqueda + vistas guardadas + facetas
// (Estado · Tarifa · Segmento · Saldo · Último pedido). Reutiliza el lenguaje
...
export function CustomerFacets({
  search,
  onSearchChange,
  savedViews,
  onSavedView,
    ...
    >
      ...
      <section className="cat-facet">
        ...
        {savedViews.map((v) => (
          <button
            ...
            data-testid={`b2b-customer-view-${v.id}`}
          >
          ...
          {group.options.map((opt) => {
            ...
            return (
              <label
                ...
                data-testid={`b2b-customer-facet-${group.key}`}
      ...
      {showClear && (
        <button
          ...
          onClick={onClear}
          data-testid="b2b-customer-clear"
        >
